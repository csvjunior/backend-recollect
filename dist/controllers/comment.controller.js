...
var CommentController = /** @class */ (function () {
    ...
    CommentController.prototype.index = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var comment;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1["default"].comment.findMany()];
                    case 1:
                        comment = _a.sent();
                        res
                            .json({ message: "Mensagem recuperada com sucesso!", comment: comment })
                            .status(200);
                        return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, res.json(comment).status(200)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, database_1["default"].comment["delete"]({
                                where: {
                                    id: id
                                }
                            })];
